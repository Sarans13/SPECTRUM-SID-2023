  ...
  return (
    <>
      <body>
        ...
        <div class="border-b-gray-400  border-b-2 ml-[91px] mr-[80px]">
          <p class="text-[#CAC9C9]/[87] w-[1067px] h-[35px]  text-[42px] font-[400] leading-[49px] tracking-[0.025em]  not-italic" id="cyber">
            ALL SOFTWARE, HARDCORE & DESIGN
          </p>
          <div class=" flex justify-between pb-12">
            <div class="text-[#E5E5E5] w-[600px] h-[92px]  font-[400] text-[102.985px] leading-[119px] tracking-[0.025em] not-italic" id="cyber">
              DOMAINS
            </div>
            <div class="flex pt-11 gap-[19.2px]">
              <div class="bg-[#E86555] w-[32px] h-[32px] "></div>
              <div class="bg-[#303636] w-[32px] h-[32px]  border-[1.6px] border-[#CAC9C9]/[87]"></div>
              <div class="bg-[#303636] w-[32px] h-[32px]  border-[1.6px] border-[#CAC9C9]/[87]"></div>
            </div>
          </div>
        </div>
        <div class="flex justify-between  ml-[89.89px] mr-[104.82px] pt-[71.87px] space-x-2 pb-14 ">
        ...
        <br/><br/><br/><br/>
        <div class="border-b-gray-400  border-b-2 ml-[91px] mr-[80px]">
          <p class="text-[#B6B6B6] w-[934px] h-[39px]  text-[42px] font-[400] leading-[49px] tracking-[0.025em]  not-italic" id="cyber">
        ...
        <div/>
        <div class="text-[#CAC9C9] pt-[22.9px] ml-[91px] mr-[80px] " id="jmh">
          The internship drive is divided into five types 
        </div>
        <div class=" pt-[53.88px] ml-[91px] mr-[80px] flex">
          <div>
          <img src="Rectangle 19.png" class="w-[310.36px] h-[187px]" alt="image" />
          </div>
          <div class="flex">
            <div class="flex-col">
              <div>
          <p class="text-[#E5E5E5] w-[386.23px] h-[29.93px]   font-[400] text-[22.4441px] leading-[26px] not-italic" id="cyber">REGISTRATION PHASE</p>
            <p class="text-[#CAC9C9]/[87] w-[333px] h-[108px]   font-[400] text-[14.1734px] leading-[18px]  not-italic " id="jmh">Students need to register themselves at https://internship.spectrumcet.com . It is mandatory for all the 
